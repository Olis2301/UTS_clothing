            ...
            <tbody>
                <?php foreach ($customer as $p) : ?>
                    <tr>
                        ...
                        <td><?= $p["card_name"]; ?></td>
                        <td>
                            <a href="edit_customer.php?id=<?= $p['id']; ?>" class="btn btn-warning">Edit</a>
                            <a href="delete_customer.php?id=<?= $p['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
